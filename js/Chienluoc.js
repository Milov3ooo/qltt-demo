...
// Thêm hàm để ngăn chặn lướt quảng cáo
function stopScrollToFooter() {
    window.removeEventListener('scroll', scrollToFooter);
}

// Gọi hàm stopScrollToFooter() khi lướt quảng cáo dừng lại
// Ví dụ: 
